<x-layouts.guest>
    <div class="bg-white dark:bg-gray-800 w-full max-w-md rounded-lg px-5 py-8 shadow-md">
        <h1 class="text-gray-800 dark:text-white text-3xl font-bold text-center mb-4">{{ __('auth.forgot_password') }}</h1>
        ...
        <x-form :action="route('password.email')" post class="space-y-3">
            <p class="text-sm text-center text-gray-800 dark:text-white">{{ __('auth.forgot_password_description') }}</p>
