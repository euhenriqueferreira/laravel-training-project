    ...
    <div class="w-full h-full max-w-screen-lg mx-auto flex items-center justify-between gap-x-4">
        ...
        <div x-data="{ dropdownOpen: false }" class="relative">
            ...
            >
                ...
                <x-anchor href="{{ route('logout') }}" onclick="return confirm('Are you sure?')" class="flex items-center justify-between gap-x-1 no-underline text-base w-full bg-transparent py-2 px-3 hover:bg-gray-300 dark:hover:bg-gray-600 transition rounded-md text-gray-900 dark:text-white">
                    Logout
