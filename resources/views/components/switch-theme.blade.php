<div id="theme-toggle" class="absolute bg-white dark:bg-gray-800 w-10 h-10 right-4 top-4 rounded-md shadow-md flex items-center justify-center cursor-pointer hover:scale-105">
